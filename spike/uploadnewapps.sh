...
rm apps.zip
zip -r apps.zip apps
#curl http://163.1.127.173/packages/admiral-test -F filename=apps.zip -F file=@apps.zip -F id=apps -u admiral:admiral -H "Accept: text/html,application/xhtml+xml"
